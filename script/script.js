...
let revealed = Array(10).fill(0).map(() => Array(10).fill(false));
let flagged = Array(10).fill(0).map(() => Array(10).fill(false));
...
function revealCell(row, col) {
    if (row < 0 || row >= 10 || col < 0 || col >= 10 || revealed[row][col] || flagged[row][col]) {
        return;
    }
...
function initGame() {
    ...
    revealed = Array(10).fill(0).map(() => Array(10).fill(false));
    flagged = Array(10).fill(0).map(() => Array(10).fill(false));
    createBoard();
    placeMines();
    countMines();
}
